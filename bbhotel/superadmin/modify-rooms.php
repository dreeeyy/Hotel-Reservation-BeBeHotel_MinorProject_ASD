...
<?php
    ...
    if(isset($_POST['updatebtn']))
    {
        ...
        $price = $_POST['pword'];
        $availability = $_POST['cpword'];
       
        // variables for input data

        // sql query for update data into database
        $sql_query = "UPDATE rooms SET price='$price',availability='$availability' WHERE id=".$_GET['edit_id'];
        // sql query for update data into database
            ...
            <form method="post">
                <div class="signup_text">User</div>
                    <div class="signup_con">
                        ...
                        <span class="cpword">
                            <b>Availability</b>
                            <input type="text" placeholder="Enter Availabilty" name="cpword" value="<?php echo $fetched_row['availability']; ?>" required>
                        </span>
